...
export function TokenCasingForm(props: TokenCasingFormProps) {
    ...
    return (
        <div className="row">
            <div className="col-sm-12 col-lg-6 d-flex flex-column border-right justify-center">
                <div className="row">
            ...
            <div className="col-sm-12 col-lg-6 d-flex justify-center items-center flex-column">
