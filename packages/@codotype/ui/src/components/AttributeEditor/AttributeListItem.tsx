            ...
            {provided => (
                <li
                    className={classnames(
                        "cursor-pointer flex justify-between group bg-white dark:text-gray-200 dark:bg-gray-900 hover:bg-gray-100 border-l-4 py-2 px-2 text-gray-900 font-light",
                        {
                            "border-green-600":
