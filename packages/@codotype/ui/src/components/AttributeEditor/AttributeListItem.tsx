...
export function AttributeListItem(props: {
    ...
    return (
        <Draggable draggableId={String(attribute.id)} index={props.index}>
            {provided => (
                <li
                    className={classnames("bg-white py-1 px-2 group", {
                        // autoGenerated: attribute.createdBy === CreatedByValues.plugin,
                    })}
                    onClick={() => {
                ...
                >
                    <div className="col-sm-10 group-hover:opacity-50">
                    ...
                    {attribute.locked && (
                        <div className="col-sm-2 text-right justify-end">
                            <span
