...
export function RelationListItem(props: {
    ...
    return (
        <Draggable draggableId={String(relation.id)} index={props.index}>
            {provided => (
                <li
                    className="cursor-pointer flex justify-between group bg-white dark:bg-gray-900 dark:text-gray-200 hover:bg-gray-100 border-primary-500 border-l-4 py-2 px-2 text-gray-900 font-light"
