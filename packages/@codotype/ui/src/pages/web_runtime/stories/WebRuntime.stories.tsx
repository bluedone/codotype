...
export const WithSchemas = Template.bind({});
WithSchemas.args = {
    plugin: dummyPluginMetadata,
};

export const WithSchemasAndConfigurationGroups = Template.bind({});
WithSchemasAndConfigurationGroups.args = {
    plugin: {
        ...dummyPluginMetadata,
        identifier: "chrome_extension_plugin_03", // unique ID for the plugin
        schemaEditorConfiguration: {
...
export const WithExampleProjects = Template.bind({});
WithExampleProjects.args = {
    plugin: {
        ...pluginExample01,
...
export const WithSchemasAndDefaultAttributes = Template.bind({});
WithSchemasAndDefaultAttributes.args = {
    plugin: {
        ...dummyPluginMetadata,
...
export const AwsCdkStarter = Template.bind({});
AwsCdkStarter.args = {
    plugin: {
        ...cdkPluginMeta,
        content: {
...
export const ConceptNextJSWebsiteStarter = Template.bind({});
ConceptNextJSWebsiteStarter.args = {
    plugin: NextJsWebsiteStarterPlugin,
};

export const ConceptNextJSWebsiteStarterVariant = Template.bind({});
ConceptNextJSWebsiteStarterVariant.args = {
    plugin: NextJsWebsiteStarterPluginVariant,
};

export const ConceptRailsStarter = Template.bind({});
ConceptRailsStarter.args = {
    plugin: RailsStarterPlugin,
};

export const ReactComponentLibraryStarter = Template.bind({});
ReactComponentLibraryStarter.args = {
    plugin: ReactComponentLibraryStarterPlugin,
};
export const ConceptNextMongoStarter = Template.bind({});
ConceptNextMongoStarter.args = {
    plugin: NextMongoStarter,
};
